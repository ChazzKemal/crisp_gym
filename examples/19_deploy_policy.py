    ...
    try:
        ...
        write_run_artifacts(
            RunRecord(
                ...
                starvation_event_count=starvation_event_count,
                chunk_rows=chunk_rows,
                pred_dt_samples=pred_dt_samples,
                pred_dt_samples_shadow=pred_dt_samples_shadow,
                stage_samples_producer=stage_samples_producer,
                sender_stage_samples=sender_stage_samples,
                trace_records=trace_records,
                trace_images_buf=trace_images_buf,
                shadow_action_history=shadow_action_history,
                shadow_inpaint_blend_total=shadow_inpaint_blend_total,
                shadow_inpaint_delta_sum=shadow_inpaint_delta_sum,
            ),
            args, sender, shadow_policy,
        )
